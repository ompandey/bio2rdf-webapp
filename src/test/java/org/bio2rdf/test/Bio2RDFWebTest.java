...
public class Bio2RDFWebTest extends AbstractQueryAllWebTest
{
    ...
    /**
     * Tests that the /admin/namespaceproviders page was generated using the correct headers and
     * that it wasn't interrupted
     */
    @Test
    public void testAdminNamespaceProviders()
    {
        ...
        // Verify that there are no providers without namespaces or namespaces without providers or
        // providers with unrecognised query types
    ...
    /**
     * Tests that the /admin/profiles page was generated using the correct headers and that it
     * wasn't interrupted
     */
    @Test
    public void testAdminProfiles()
    {
        ...
        this.getWebTester().assertTextPresent(
                "The following list is authoritative across all of the currently enabled profiles");
        ...
        this.getWebTester()
                .assertTextPresent(
                        "The next section details the profile by profile details, and does not necessarily match the actual effect if there is more than one profile enabled");
    }
    
    /**
     * Tests that the /admin/stats page was generated using the correct headers and that it wasn't
     * interrupted
     */
    @Test
